    ...
    $.fn.dynamicContextMenu = function (params) {
        ...
        var members = {
            ...
            get_containerSelector: function () {
                return "ol." + this.get_style().containerCssClass;
            },
            ...
            open: function () {
                ...
                contextMenu.setAttribute("className", this.get_style().containerCssClass);
                ...
                contextMenu.css({ top: this.get_mousePosition().top - 10, left: this.get_mousePosition().left - 50 });
                contextMenu.fadeIn("fast", function () { currentObject.set_isOpen(true) });
                
				//added starnernj to highlight the correctly previously select item
				highlight_selected_item(this._id);
            },
            ...
            createMenuItem: function (item) {
                ...
                //$(tempItem).css("background-color", "gray");
        ...
        $("body").on("mousemove", { sender: members }, members.body_MouseMove);
    };
})(jQuery);
function highlight_selected_item(field)
{
	jQuery("ol#" + field + " li#" + jQuery("#"+field+"_filter_value").val()).css("background-color", "#C0C0C0");
}